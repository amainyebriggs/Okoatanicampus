...
<div class="form-group">	  
					<label for="inputPassword" class="sr-only"><?php echo $this->lang->line('ADMISSION_NUMBER');?></label>
					<input type="text" id="inputPassword" name="regno"  class="form-control" placeholder="<?php echo $this->lang->line('ADMISSION_NUMBER');?> or Username for Lecturers" required >
			 </div>
			<div class="form-group">	  
