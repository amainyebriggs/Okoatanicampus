...
?>
<tr><td><?php echo $qk+1;?></td><td><?php echo $val['first_name'];?> <?php echo $val['last_name'];?> <?php echo $val['ADMISSION_NUMBER'];?></td><td><?php echo $val['score_obtained'];?></td><td><?php echo $val['percentage_obtained'];?>%</td></tr>
<?php 
}
?>
</table>
