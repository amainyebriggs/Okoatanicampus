...
<tr>
 ...
 <td><?php echo $val['requested_by_name'];?> <br><?php echo $this->lang->line('ADMISSION_NUMBER');?>: <?php echo $val['requested_by_skype'];?></td>
  <td><?php echo $val['appointed_to_name'];?> <br><?php echo $this->lang->line('ADMISSION_NUMBER');?>: <?php echo $val['appointed_to_skype'];?></td>
