 ...
 <div class="login-panel panel panel-default">
		...
		?>	
			...
			<div class="form-group">	  
				...
				<div class="form-group">	 
					<label for="inputEmail" class="sr-only"><?php echo $this->lang->line('ADMISSION_NUMBER');?></label> 
					<input type="text" name="ADMISSION_NUMBER"  class="form-control"  value="<?php echo $result['ADMISSION_NUMBER'];?>"  placeholder="<?php echo $this->lang->line('ADMISSION_NUMBER');?>"   autofocus>
			</div>
