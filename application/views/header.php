  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        ...
        <div class="sidebar-brand-text mx-3"><?php if($hres[0]['setting_value']==""){ ?>ACET Software<sup>5.0</sup><?php }else{ echo $hres[0]['setting_value']; }?> </div>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				...
				<?php echo $logged_in['first_name'].' '.$logged_in['last_name'].' '.$logged_in['ADMISSION_NUMBER'];?> </span>
...
<?php 
if($logged_in['su']=='1' or $logged_in['su']=='3' or $logged_in['su']=='4'){
	?>
 ...
 <?php 
			...
			?>
<a class="dropdown-item" href="<?php echo site_url('user/logout1');?>"  >
                  <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                  Logout
                </a>
			<?php 
