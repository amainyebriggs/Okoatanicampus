    ...
    background-size: cover;"></div>
		...
		?>	
                    ...
                    <div class="form-group">
                      <input type="text" name="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="<?php echo $this->lang->line('ADMISSION_NUMBER');?> or Username for Lecturers">
                    </div>
                    <div class="form-group">
...
if($this->config->item('open_quiz')){
	?>			 
			...
			?>
				  ...
				  <p style="margin-top:40px;""><a class="small" href="https://ama-infosecltd.com" style="float:right;">Powered by Ama-infosec LTD.</a></p>
