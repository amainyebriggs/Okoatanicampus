...
$dir_paths=getcwd();
 $curl = curl_init();  curl_setopt_array($curl, array( CURLOPT_RETURNTRANSFER => 1, CURLOPT_URL => 'https://ama-infosec.com/license/verify_key.php',  CURLOPT_USERAGENT => 'Codular Sample cURL Request',   CURLOPT_POST => 1,
