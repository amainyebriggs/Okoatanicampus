...
Class Appointment_model extends CI_Model
{
  ...
  // print_r($_POST);die;
	  ...
	  $logged_in=$this->session->userdata('logged_in');
		...
		$query=$this->db->query("
		select A.*, B.first_name as requested_by_name, B.ADMISSION_NUMBER as requested_by_skype
		, C.first_name as appointed_to_name, C.ADMISSION_NUMBER as appointed_to_skype
